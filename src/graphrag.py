...
class LocalEmbedder:
    ...
    def __init__(self, model: str = EMBED_MODEL):
        ...
        try:
            ...
            logger.exception("Failed to load embedding model '%s' — embeddings disabled", model)
...
class LLMAnswerer:
    ...
    def __init__(self, embedder: LocalEmbedder, model: str = "local-qwen3"):  # noqa: ARG002
        self.embedder = embedder
        self.model = model

    def answer_question(self, question: str, triples: list[Triple]) -> str:  # noqa: ARG002
...
class GraphRAG:
    ...
    def __init__(self,
        ...
        Args:
            ...
            embed_model: sentence-transformers model name or local path.
        """
